...
use music_base::Span;
use music_hir::{
    HirArg, HirArrayItem, HirAttr, HirAttrArg, HirBinder, HirConstraint, HirDim, HirExprId,
    HirFieldDef, HirMatchArm, HirMemberDef, HirParam, HirPatId, HirRecordItem, HirRecordPatField,
    HirTemplatePart, HirTyField, HirTyId, HirVariantDef, HirVariantFieldDef, HirVariantPatArg,
};
use music_module::ModuleKey;
use music_names::{Ident, NameBindingId, NameSite, Symbol};

use crate::api::{
    ComptimeValue, ConstraintEvidence, ConstraintKey, DefinitionKey, ExprFacts, ExprMemberFact,
    ForeignLinkInfo, PatFacts, SemaDataDef, SemaDataVariantDef, ShapeFacts,
};
...
pub type ExprConstraintEvidenceMap = HashMap<HirExprId, Box<[ConstraintEvidence]>>;
...
pub type ConstraintEvidenceScope = HashMap<ConstraintKey, ConstraintEvidence>;
pub type ConstraintEvidenceScopeList = Vec<ConstraintEvidenceScope>;
