# SEIL opcode registry

Project evidence: `seil_opcodes.def`.

The locked core opcode registry is authoritative for core opcode ids, canonical mnemonics, operand schemas, and stack-effect schemas. SEAM binary image stores numeric opcode ids; SEIL text stores canonical mnemonics.
